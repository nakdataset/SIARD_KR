 ...
 *         &lt;element name="columns" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}columnsType"/>
 *         &lt;element name="primaryKey" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}uniqueKeyType" minOccurs="0"/>
 *         &lt;element name="foreignKeys" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}foreignKeysType" minOccurs="0"/>
 *         &lt;element name="candidateKeys" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}candidateKeysType" minOccurs="0"/>
 *         &lt;element name="checkConstraints" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}checkConstraintsType" minOccurs="0"/>
 *         &lt;element name="triggers" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}triggersType" minOccurs="0"/>
...
@XmlType(name = "tableType", namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd", propOrder = {
    "name",
    "folder",
    "description",
    "columns",
...
public class TableType {
    ...
    @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd")
    protected UniqueKeyType primaryKey;
    @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd")
     ...
     *     
     */
    public UniqueKeyType getPrimaryKey() {
        return primaryKey;
    }
     ...
     *     
     */
    public void setPrimaryKey(UniqueKeyType value) {
