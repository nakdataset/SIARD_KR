 ...
 * 
 * <p>candidateKeysType complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="candidateKey" type="{http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd}uniqueKeyType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "candidateKeysType", namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd", propOrder = {
    "candidateKey"
})
public class CandidateKeysType {
    ...
    public List<UniqueKeyType> getCandidateKey() {
        if (candidateKey == null) {
            candidateKey = new ArrayList<UniqueKeyType>();
        }
