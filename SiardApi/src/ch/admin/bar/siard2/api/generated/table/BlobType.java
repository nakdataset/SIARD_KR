...
/**
 * a binary large object stored separately (addressed by URI). The digest makes sure, the connection to the external object is not completely lost. The length is in bytes.
 * 
 * <p>blobType complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "blobType", namespace = "http://www.bar.admin.ch/xmlns/siard/2/table.xsd", propOrder = {
    "value"
})
