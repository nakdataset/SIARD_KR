/*======================================================================
CubridSqlXml implements an SqlXml instance
Version     : $Id: $
Application : SIARD2
Description : CubridSqlXml implements an SqlXml instance
Platform    : Java 7   
------------------------------------------------------------------------
 ...
 * @author Simon Jutz
 */
public class CUBRIDSqlXml extends BaseSqlXml implements SQLXML {
	 ...
	 */
	public CUBRIDSqlXml(SQLXML sqlxmlWrapped) {
		super(sqlxmlWrapped);
	} /* constructor */
	...
	/**
	 * gets a new CubridSqlXml instance
	 * @return a new CubridSqlXml instance
	 */
	public static CUBRIDSqlXml getInstance() {
		return new CUBRIDSqlXml(null);
	} /* getIntance */
