...
//		input_y_position += input_height + line_interval;
		...
		btn_change.setBounds(input_x_position, input_y_position, 80, 20);
		btn_comment.setBounds(input_x_position + 80 + 5, input_y_position, 190, 20);
		btn_report.setBounds(input_x_position + 80 + 5 + 190 + 5, input_y_position, 80, 20);
...
//	}
	...
	public void viewrefesh(String str_number)
	{
		...
		EraserService	service	= new EraserServiceImpl();
		Hashtable		hash	= (Hashtable) service.eraserview(this.number);
