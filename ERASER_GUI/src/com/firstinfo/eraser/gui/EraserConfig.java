...
public class EraserConfig extends JPanel
{
	...
	EraserConfig()
	{
		...
		btn_save.setBounds(input_x_position - 1, input_y_position, 120, input_height);
		btn_test.setBounds(input_x_position + 120 + 5, input_y_position, 120, input_height);
		label_y_position += label_height + line_interval;
		input_y_position += input_height + line_interval;
