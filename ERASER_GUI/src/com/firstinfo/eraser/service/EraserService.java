...
public interface EraserService
{
	...
	/**
	 * 삭제 스크립트 변경 >> 기존 txt파일 삭제 -> 신규 txt파일 생성
	 * 
	 * @param number
	 * @param title
	 * @param date
	...
	/**
	 * 삭제 스크립트 실행 >> DBMS 접속 -> txt파일의 sql읽기 -> sql실행
	 * 
	 * @param number
	 * @param title
	 * @param test
