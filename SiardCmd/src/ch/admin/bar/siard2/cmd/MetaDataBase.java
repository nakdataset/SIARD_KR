...
public abstract class MetaDataBase
{
    ...
    throws SQLException
  {
	...
	protected MetaDataBase(DatabaseMetaData dmd, MetaData md, String schemaName) throws SQLException
	{
		_dmd = (BaseDatabaseMetaData) dmd;
		_md = md;
		...
		ResultSet rs = _dmd.getUDTs(null, schemaName.toUpperCase(), "%", null);
		while (rs.next() && ((_bSupportsUdts == false) || (_bSupportsDistincts == false)))
		{
			String sTypeSchema = rs.getString("TYPE_SCHEM");
			String sTypeName = rs.getString("TYPE_NAME");
