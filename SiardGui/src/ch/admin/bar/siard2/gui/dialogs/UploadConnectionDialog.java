/*
 * ====================================================================== UploadConnectionDialog for
 * entering data to connect to a database. Application : Siard2 Description : UploadConnectionDialog
 * for entering data to connect to a database for upload. Platform : Java 7, JavaFX 2.2
 * ------------------------------------------------------------------------ Copyright : Swiss
 * Federal Archives, Berne, Switzerland, 2017 Created : 29.06.2017, Hartwig Thomas, Enter AG, Rüti
 * ZH ======================================================================
 */
...
//			lbl.setPrefWidth(dLabelWidth*2);
			lbl.setPrefWidth(getTmpDbSchemeLabel().getPrefWidth()); /* IntraDIGM */
			lbl.setMinWidth(getTmpDbSchemeLabel().getPrefWidth());
...
//		vboxDialog.setMinWidth(dMinWidth);
	 ...
	 * @param archive SIARD archive to be uploaded.
	 * @return UpConnectionDialog instance with results. if getResult() is 1 then getConnectionUrl(),
	 *         getDbUser(), getDbPassword(), isMetaDataOnly(), isOverwrite(), and getSchemasMap() have
	 *         the values entered.
	 */
