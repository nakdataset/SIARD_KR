/*
 * ====================================================================== The editor VBox of a
 * single option. Application: SIARD GUI Description: The editor VBox of a single option. Platform :
 * JAVA 1.7, JavaFX 2.2 ------------------------------------------------------------------------
 * Copyright : Swiss Federal Archives, Berne, Switzerland, 2017 Created : 25.07.2017, Hartwig
 * Thomas, Enter AG, Rüti ZH ======================================================================
 */
 ...
 * 
 * @param T value type: File for files and folders, Integer for integers, String for strings.
	...
	implements EventHandler<ActionEvent>, ChangeListener<String>
{
	...
	/*------------------------------------------------------------------*/
	/**
	 * constructor creates a VBox containing an explanation and a labeled text input field.
	 * 
	 * @param sExplanation explanation of the value.
	 * @param sLabel label of the value.
	 * @param dLabelWidth width of the label.
	 * @param oValue initial value (File, Integer or String) - must not be null if it is a folder.
	 */
