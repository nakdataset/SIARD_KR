 ...
 */
public abstract class ConnectionDialog_original extends ScrollableDialog
{
  /** logger */
  private static IndentLogger _il = IndentLogger.getIndentLogger(ConnectionDialog_original.class.getName());
    ...
    implements EventHandler<ActionEvent>
  {
    ...
    public void handle(ActionEvent ae)
    {
      ...
      else if (ae.getSource() == _btnDbFolder)
      {
        ...
        try
        {
          fileDbFolder = FS.chooseExistingFolder(ConnectionDialog_original.this,
...
//		_tvSelectTable.setItems(rowdata);
   ...
   * @param sLoadViewsAsTablesTooltip tool tip for views as tables check box.
   */
  protected ConnectionDialog_original(Stage stageOwner, String sConnectionUrl, String sDbUser,
...
//		params.put("div", "0001");
//		params.put("db_name", "mysql");
//		params.put("db_con_url", "http://localhost:303030:3030303::30303030303030asdfasdf&askdflikja=utf8http://localhost:303030:3030303::30303030303030asdfasdf&askdflikja=utf8");
//		params.put("schema_name", "mysql");
//		params.put("table_count", "9999999999");
//		params.put("execute_result", "1");
//
//		params.put("table_name", "student");
//		params.put("table_column_count", "9");
//		params.put("table_record_count", "99");
//
...
//			System.out.println("sql:" + sql);
			...
			SiardConnection.getSiardConnection().loadDriver(sUrl);
			*/
			connection = DriverManager.getConnection(url, user, password);
			statement = connection.createStatement();
			resultset = statement.unwrap(Statement.class).executeQuery(sql);
