/*
 * ====================================================================== VBox with list view with
 * check boxes for column names. Application : Siard2 Description : VBox with list view with check
 * boxes for column names. Platform : Java 7, JavaFX 2.2
	...
	implements EventHandler<ActionEvent>
{
	...
	public MetaColumnsListView getMetaColumnsListView()
	{
		return _mclv;
	}
	...
	/* ================================================================== */
	/**
	 * check box list cell for pairs of column meta data and selected property.
	 */
